...
public class HomePage {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		System.out.println(getElementText(driver, createAccountButton, 8));

		
		//To send email address as testEmail@gmail.com
		WebElement createAccountEmail = driver.findElement(By.id("email_create"));
		typeText(driver, createAccountEmail, 3, "testEmail@gmail.com");
		
		//To click on the button after load - 5 sec
		clickOn(driver, createAccountButton, 5);
